// $Id: PersevereDataStore.as 2104 2011-04-06 21:02:06Z marcelo $
	 ...
	 */	
	 public class PersevereDataStore extends EventDispatcher implements IDataStore {
		...
		public function retrieveData(uid:String):void {
			...
			// Alert.show("Retrieving experiment: url=" + retrieveService.url + "\n     destination=" + retrieveService.destination);
