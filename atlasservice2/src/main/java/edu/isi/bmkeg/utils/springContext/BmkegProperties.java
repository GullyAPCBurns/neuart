...
public class BmkegProperties {
	 ...
	 */
	public BmkegProperties(boolean useProperties) throws IOException {
		
		Properties properties = new Properties();
		properties.load(ClassLoader.getSystemResourceAsStream("bmkeg.properties"));
		...
		if( !homeDirectoryAddress.endsWith(fileSeparator))
